...
export default function LayoutCall({
  ...
  return (
    <div className="border-bw/30 relative z-5 flex h-full max-h-[34rem] w-[98%] max-w-[29.5rem] items-center overflow-hidden rounded-[25px] bg-[#012463] sm:w-[99%] md:w-[99%] lg:max-w-[59rem]">
      <div
