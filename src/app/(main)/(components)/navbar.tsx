...
export default function Navbar() {
  ...
  return (
    <div className="bg-nav-grad ring-main-bg/60 absolute top-0.5 z-5 ml-3 flex h-[3rem] w-[89%] flex-none items-center justify-between gap-1 self-center overflow-hidden rounded-[5px] shadow-lg ring-2 shadow-black">
