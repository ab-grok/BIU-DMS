...
export function RowItem({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`${hovered ? "text-bw" : ""} ${bold ? "font-medium" : ""} ${textSize ? textSize : "text-xs"} ${childCount > 1 ? "justify-start" : "justify-center"} ${itemsStart ? "items-start text-start" : "items-center text-center"} ${italics && "italic"} text-sub-text scrollbar-custom relative flex h-[80%] min-w-full flex-col gap-1 overflow-clip bg-amber-400/50 p-1`}
        >
