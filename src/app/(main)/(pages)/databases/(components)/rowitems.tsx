...
export function RowItem({
  ...
  return (
    <div
      ...
      onMouseOver={() => hover(0)}
      className={`hover:bg-card-selection ${clicked ? "bg-card-selection/60" : i % 2 == 0 ? "bg-row-bg1/70" : "bg-row-bg1"} ${extend && clicked ? "h-fit" : "h-[4rem]"} group text-bw shadow-shadow-bw ml-3 flex min-h-[4rem] w-full max-w-[10rem] min-w-[10rem] cursor-pointer flex-col p-1 font-medium shadow-sm`}
    >
      <div
